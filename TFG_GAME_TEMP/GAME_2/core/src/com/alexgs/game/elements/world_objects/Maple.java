...
public class Maple extends WorldObjects {

    public Maple(float x, float y, Stage s, GameScreen lvl) {
        super(x, y, s, lvl);

        super.animation = loadFullAnimation("world/world_obj/trees/maple.png", 1, 1, 0, true);
